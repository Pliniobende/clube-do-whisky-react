    ...
    <Formik initialValues={initialValues} onSubmit={handleSubmit} validationSchema={validations}>
        ...
        <div className="DivForm">
            ...
            <div className="Form-Group">
                ...
                <ErrorMessage className="Form-Error" component="span" name="mobile"/>
            </div>
            <label className="Form-Label">Receber news-letter: </label>
            <div className="Form-Group2">
                <label className="Form-Label">Sim</label>
                <Field  className="Form-Radio" name="newsLetter" type="radio" value="true"/>
                <label className="Form-Label">Não</label>
                <Field  className="Form-Radio" name="newsLetter" type="radio" value="false"/>
                <ErrorMessage className="Form-Error" component="span" name="mobile"/>
            </div>
